...
Reglas:
- daysPerCity: días a pasar en cada ciudad destino (mismo orden que destinationCities). Si el usuario dice "2 semanas" para 2 ciudades → [7, 7]. Si dice "4 días en BA y 3 en Montevideo" → [4, 3]. Default: 4 días por ciudad.
- departureDate: fecha de salida del origen. Si dice "julio" sin día específico usa el 10. Si dice "del 15" usa el 15. Año futuro más cercano. Si no hay fecha, 2 meses desde hoy.
